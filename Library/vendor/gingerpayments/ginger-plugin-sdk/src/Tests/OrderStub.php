...
class OrderStub
{
    ...
    public function getValidCustomer(): Customer
    {
        return new Customer(
    ...
    public function getValidClient(): \GingerPluginSdk\Entities\Client
    {
    ...
    public function getValidExtra(): Extra
    {
        return new Extra(
            ['sw_order_id' => "501"]
        );
    ...
    public function getValidOrderLines(): OrderLines
    {
